(function() {
	...
	*/
	...
	test( 'attr(String, Object)', function() {
		...
		equal( 'checkbox', jQuery( check ).attr('type'), 'Verify that you can change the type of an input element that isnt in the DOM');
	...
	var testRemoveClass = function(valueObj) {
		...
		strictEqual( jQuery( div ).attr('class'), undefined, 'removeClass doesnt create a class attribute');
